        ...
        <ul class="nav navbar-nav" style="padding-left: 150px">
            <c:forEach var="category" items="${categoryList}">
                <li <c:if test="${cat eq category}">class="active"</c:if>>
                    <a href="/shop/viewCategory/${category}" style="font-size: 18px; color: #262626; font-family: 'Monaco',monospace">${category}</a></li>
            </c:forEach>
        </ul>
    </div>
</nav>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="search">
            <form method="get" action="/shop/searchProductResult/${category}">
                <input type="text" name="str" placeholder="Search Product...">
                <button type="submit" href="/shop/viewShop/${shop.shopname}/searchProductResult/${category}" style="border: none">
        ...
        <div class="sort">
            ...
            <form method="get" action="/shop/sortProductResult/${category}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h4 style="font-family: Monaco, monospace; text-align: left">${product.name}
                        <a href="/shop/deleteProduct/${product.pid}" onclick="return confirm('Are you sure you want to delete it?');">
                            <i class="fa fa-trash" aria-hidden="true" style="font-size:24px; float: right"></i>
                        </a>
                        <a href="/shop/editProduct/${product.pid}">
                            <i class="fa fa-pencil-square-o" style="font-size:24px; float: right; padding-right: 15px"></i>
                        </a>
                    </h4>
