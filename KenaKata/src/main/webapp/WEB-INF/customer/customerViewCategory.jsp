...
<head>
    <title>View Product by Category</title>
    <meta charset="utf-8">
        ...
        <ul class="nav navbar-nav" style="padding-left: 100px">
            <c:forEach var="category" items="${categoryList}">
                <li <c:if test="${cat eq category}">class="active"</c:if>>
                    <a href="/customer/viewShop/${shopname}/viewCategory/${category}" style="font-size: 18px; color: #262626; font-family: 'Monaco',monospace">${category}</a></li>
            </c:forEach>
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li>
                <a class="review" href="/customer/viewShop/${shop.shopname}/reviews">Reviews</a>
            </li>
        </ul>
    </div>
</nav>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="search">
            <form method="get" action="/customer/viewShop/${shopname}/searchProductResult/${category}">
                <input type="text" name="str" placeholder="Search Product...">
                <button type="submit" href="/customer/viewShop/${shopname}/searchProductResult/${category}" style="border: none">
        ...
        <div class="sort">
            ...
            <form method="get" action="/customer/viewShop/${shopname}/sortProductResult/${category}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h4 style="font-family: Monaco, monospace; text-align: left">${product.name}
                        <a href="/customer/viewShop/${shopname}/viewProduct/${product.pid}">
