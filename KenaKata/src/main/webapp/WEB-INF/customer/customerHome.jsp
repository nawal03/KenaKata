...
<nav class="navbar navbar-default" style="background-color: #262626">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li class="actv"><a href="/customer/home" style="color: #f2f2f2; font-family: 'Monaco',monospace"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
        </ul>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="search">
            <form method="get" action="/customer/searchShop">
        ...
        <div class="sort">
            ...
            <form method="get" action="/customer/filterShop">
        ...
        <c:forEach var="shop" items="${shopList}">
            <div class="card">
                <div class="background" style="box-shadow: 3px 3px 12px gray; background-color: rgba(235, 235, 235, 1); border-radius: 5px; padding-bottom: 5px">
                    ...
                    <div class="card-body">
                        <a href="/customer/viewShop/${shop.shopname}" style="color: #d4122b">
                            <h4 style="font-family: 'oswald'; font-weight: bold; text-align: center; font-size: 28px">${shop.shopname}
                        </a>
                        </h4>
                    </div>
                </div>
